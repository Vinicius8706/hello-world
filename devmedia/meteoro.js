let meteoros_trimestre_um = "Alfa Centurídeos começa em 03/01 e termina em 05/01\nGama Normídeos começa em 17/02 e termina em 20/02\n Pupídeos começa em 25/03 e termina em 29/03"

let meteoros_trimestre_dois = "Lirídas começa em 23/05 e termina em 26/05\nEta Aquáridas começa em 31/05 e termina em 02/06\nBootídeos de Junho começa em 16/06 e termina em 20/06"
...
if(mes_atual == 0 || mes_atual == 1 || mes_atual == 2){
    ...
    console.log("As chuvas de meteoros do quarto trimestre são:\n\n"+ meteoros_trimestre_quarto)
}

else{
    console.log("Nenhuma chuva de meteoro no período formado")
